...
* Ideas [20%]
** Hyprland [25%]
*** TODO [#C] Wallpaper (both desktop and lockscreen)
*** DONE Terminal scratchpad
*** DONE Screenlock
*** TODO Add volume controls to top bar
*** TODO Add screen light control to top bar
*** TODO Add a terminal multiplexer to terminal scratchpad
*** TODO Use a configurable color pallete for all applications
